...
class HighestPace(commands.Cog):
    ...
    @app_commands.command(name='highest', description="Show the highest pace of a person was.")#A command to show what the highest pace of a person was (it was in the TODO so I guess someone asked for it)
